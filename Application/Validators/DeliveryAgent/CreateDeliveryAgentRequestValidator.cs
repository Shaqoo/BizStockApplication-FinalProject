...
namespace Application.Validations.DeliveryAgent
{
    using Application.Dto.RequestModels;
    using FluentValidation;

    public class CreateDeliveryAgentModelValidator : AbstractValidator<CreateDeliveryAgentModel>
    {
        public CreateDeliveryAgentModelValidator()
        {
